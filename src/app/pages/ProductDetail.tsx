...
const productData: Record<string, any> = {
  'venika-hair-oil': {
    ...
    images: ['/images/venika/Venika_00.jpg'],
    benefits: [
  ...
  'medhini-anti-dandruff-oil': {
    ...
    images: ['/images/medhini/Medhini_01.jpg'],
    benefits: [
  ...
  'vama-lip-balm': {
    ...
    images: ['/images/vama/Vama_00.jpg'],
    benefits: [
  ...
  'zrika-premium-face-oil': {
    ...
    images: ['/images/zrika/Zrika_00.jpg'],
    benefits: [
  ...
  'laya-face-care-oil': {
    ...
    images: ['/images/laya/Laya_00.jpg'],
    benefits: [
